...
#SBATCH --output ./scratch-outputs/scratch_AL_MT_${STRATEGY} 
#SBATCH --nodes=1
#SBATCH --mem=32GB
#SBATCH --gres=gpu:2
...
accelerate launch --config_file ~/.cache/huggingface/accelerate/default_config.yaml --multi_gpu --num_processes=2 src/train_al.py \
