#!/bin/bash
#SBATCH --job-name=AL_MT_egalitarian-demo
#SBATCH --output /home/skhanuja/demux/scratch-outputs/scratch_AL_MT_egalitarian-demo
#SBATCH --nodes=1
#SBATCH --mem=50GB
#SBATCH --gres=gpu:1
...
# accelerate launch --main_process_port 29051 --config_file /home/skhanuja/.cache/huggingface/accelerate/default_config.yaml  --multi_gpu --num_processes=2
# --get_all_en_configs false \
